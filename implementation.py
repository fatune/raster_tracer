...
class GridWithWeights(SquareGrid):
    ...
    def cost(self, from_node, to_node):
        ...
        return self.weights[to_node[0],to_node[1]]#.get(to_node, 1)
...
diagram5 = GridWithWeights(20, 20)
#diagram5.weights = {loc: 5 for loc in [(3, 4), (3, 5), (4, 1), (4, 2),
#                                       (4, 3), (4, 4), (4, 5), (4, 6), 
#                                       (4, 7), (4, 8), (5, 1), (5, 2),
#                                       (5, 3), (5, 4), (5, 5), (5, 6), 
#                                       (5, 7), (5, 8), (6, 2), (6, 3), 
...
class PriorityQueue2:
    ...
    def get(self):
        max_priority = min(self.priorities)
        index = self.priorities.index(max_priority)
